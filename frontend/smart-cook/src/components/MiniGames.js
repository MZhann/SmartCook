    ...
    return (
        <>
            {{
                'choice': (
                    <>
                        <div className={'w-[500px] h-[221px] p-[24px] rounded-lg bg-white'}>
                            <div className={'flex justify-between w-full'}>
                                <h1 className={'text-[24px]'}>Mini games</h1>
                            ...
                            <div className={'w-full flex flex-row justify-evenly'}>
                                <div
                                    className={'mt-4 flex flex-col text-center cursor-pointer'}
                                    onClick={handleQuiz}
                                >
                                    <Image className={'flex justify-center ml-3'} width={85} height={85} src={puzzle} alt={'puzzle'}/>
                                    <p>Memory game</p>
                                </div>
                                <div
                                    ...
                                    className={'mt-4 flex flex-col text-center cursor-pointer'}
                                >
                                    <Image className={'flex justify-center ml-3'} width={85} height={85} src={game} alt={'puzzle'}/>
                                    <p>8 puzzle game</p>
                                </div>
                            </div>
                        </div>
