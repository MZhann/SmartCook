...
const Statistics = ({user}) => {
    return (
        <div className={'md:w-[278px] self-center md:self-start w-full h-[302px] px-6 py-5 bg-[#2A293B] rounded-3xl'}>
            ...
            <div className={'flex flex-col text-white gap-2 mt-6'}>
                ...
                <div className={'flex flex-row gap-3 items-center'}>
                    ...
                    <div className={`flex flex-row items-center`}><span className={'text-[20px] font-[600]'}>{user?.wins}</span>&nbsp;<span>win</span></div>
                </div>
                <div className={'flex flex-row gap-3 items-center'}>
                    <div className={'w-[38px]'}><Image src={rank} alt={'cookBattle'}
                                                       className={'w-[35.2px] h-[35.2px]'}/></div>
                    <div className={`flex flex-row items-center`}><span className={'text-[20px] font-[600]'}>{Math.floor(Math.random() * 10) + 1}</span>&nbsp;<span>rank</span></div>
                </div>
            </div>
