...
const NoBattle = () => {
    return (
        ...
        <div className="w-full sm:max-w-[574px] sm:min-h-[546px] h-[400px] sm:h-auto rounded-3xl text-white bg-[#2A293B] flex flex-col items-center justify-evenly mb-4">
            ...
            <div className='text-lg mt-3 px-4 text-center'>Currently no Culinary Battles available</div>
            <div className='text-sm px-4 text-gray-400 mt-2 text-center'>Currently not participating in any Culinary Battles</div>
        </div>
    )
}
