        ...
        <div className="w-[280px] h-[317px] bg-white rounded-lg my-5">
            <div className="w-full h-[210px] relative">
                ...
                >
                    ...
                    >
                        <rect width="35" height="35" rx="17.5" fill={!favButtonClicked ? "white" : '#4c9fed'} fillOpacity="0.8"/>
                        <path
                ...
                {recipe && recipe.image ?
                    (<Image width={280} height={211} className={'w-[px] h-[211px] rounded-tl-[8px] rounded-tr-[8px]'} src={recipe.image} alt="Food"/>):
            ...
            <div className="relative w-full h-[107px] rounded-b-lg p-4">
                <div className="flex items-center">
                    {recipe && router.pathname !== '/ai-receipts' ?
                        ...
                        (<>
                            <Image width={20} height={20} src={aiLogo} className="mr-2 rounded-5xl" alt="profile avatar"/>
