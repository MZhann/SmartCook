...
const HoverExample = () => {
    ...
    return (
        <div className="relative">
            ...
            <div
                className={`absolute top-full w-[200px] h-[100px] left-0 p-4 text-center flex justify-center items-center rounded-2xl bg-white border-black border-2 text-black opacity-0 transition-opacity duration-500 ease-in-out ${
