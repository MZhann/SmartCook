...
const opponentCreateUrl = "https://web-production-ad96.up.railway.app/api/v1/clashes/opponent/create/";
...
const OpponentMakeRecipe = () => {
        ...
        const handlePublish = async () => {
            ...
            axios.post(opponentCreateUrl, formData, config).then((response) => {
