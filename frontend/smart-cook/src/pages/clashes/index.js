...
const ClashRecipeMake = () => {
    ...
    const handlePublish = async () => {
        ...
        axios
            .post(initiatorCreateUrl, formData, config)
            .then((response) => {
                ingredients.forEach((item) => {
                    axios
                        .post(
                            apiUrl + `${response.data.id}/ingredients/`,
                            item,
                            {
                                headers: {
                ...
                <div className={"flex w-full justify-center"}>
                    <div className="flex justify-center items-center flex-col w-[750px]">
                        <div className="text-center font-montserrat mt-[60px] text-white">
                            <h1
                                className={
                                    "text-[40px] mb-[20px] font-[500] leading-10"
                                }
                            >
                        ...
                        <div className="sm:w-[750px] w-[350px] relative mt-[50px] h-[400px] bg-white flex justify-center items-center rounded-lg">
                            <input
                                className={
                                    "absolute h-[250px] w-[250px] cursor-pointer bg-opacity-0 opacity-0"
                                }
                                type="file"
                        ...
                        <div className="sm:w-[750px] w-[350px] mt-[30px] p-[24px]  bg-white flex flex-col rounded-lg ">
                            <h1 className={"text-[24px] text-[#2A293B]"}>
                                Dish details
                            </h1>
                            <div className="">
                                ...
                                <div className={"flex flex-col"}>
                                    {steps.map((step, index) => (
                                        <div key={index}>
                                            ...
                                            <div
                                                className={
                                                    "w-full justify-between flex-row flex items-center mb-3"
                                                }
                                            >
                                                <input
                                            ...
                                            <div className={"relative"}>
                                                <input
                                                    type="file"
                                                    className={
                                                        "opacity-0 cursor-pointer h-24 absolute"
                                                    }
                                                    onChange={(event) =>
                                                ...
                                                {step.image ? (
                                                    ...
                                                    <Image
                                                        src={instax}
                                                        className={
                                                            "shadow-gray-500 border-2 rounded-3xl"
                                                        }
                                                        alt="Main Image"
                                                        width={150}
                                                        height={150}
                        ...
                        {title && serves && cookTime && description ? (
                            ...
                            <div
                                className={
                                    "text-lg text-center text-[#AAE06E] mt-5 mb-6"
                                }
                            >
                                For publishing recipe enter title, description,
